...
SRC=os.path.join(DATA_DIR,'IRA.xlsx')
OUT=os.path.join(PORT_DIR,'IRA_Portfolio.xlsx')
...
wb=Workbook(); ws=wb.active; ws.title="IRA Portfolio"; ws.sheet_view.showGridLines=False
...
c=ws["A1"]; c.value="IRA Portfolio  —  Private"; c.font=Font(name="Arial",size=18,bold=True,color="FFFFFF")
